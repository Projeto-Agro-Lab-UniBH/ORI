              ...
              <div className="w-full flex flex-col gap-2">
                <div className="w-full flex flex-col gap-3">
                  ...
                  <input
                    ...
                    className={
                      errors.email
                        ? "w-full h-10 text-sm text-brand-standard-black font-normal px-3 py-3 border border-red-200 rounded bg-white hover:boder hover:border-red-500 focus:outline-red-500"
              ...
              <div className="w-full flex flex-col gap-2">
                <div className="w-full flex flex-col gap-3">
                  ...
                  <input
                    ...
                    className={
                      errors.password
                        ? "w-full h-10 px-3 py-3 text-sm text-brand-standard-black font-normal border border-red-200 rounded bg-white hover:boder hover:border-red-500 focus:outline-red-500"
                        : "w-full h-10 rounded border border-solid border-gray-200 py-3 px-3 font-normal text-sm text-brand-standard-black bg-white hover:border-[#b3b3b3]"
                    }
